...
3. For every action (e.g. code base exploration, researching, implementing features, bugfix) you want to take, create agendas to break down the task into smaller, manageable steps. This will help you stay organized and ensure that you cover all necessary aspects of the task.
