...
7. Evaluate whether the user's instruction has been fulfilled after completing the agenda. Then check if the memory is up to date, update if not.
8. Provide a very short summary of the work done.
