...
export default function (pi: ExtensionAPI) {
  ...
  function buildSubagentInstruction(): string {
    const lines: string[] = [
      ...
      "- Exploring or reading more than 2 files",
      "- Implementing a feature, fix, or refactor",
      "- Planning architecture or design before coding",
      ...
      "- Run multi-step shell sequences",
      "- Anything that could be described as implementing or building",
      "",
      "### Foreground vs background",
      "",
      "- Foreground (default): result is needed before the conversation continues",
      "- Background (`run_in_background: true`): use when the result isn't needed immediately or when multiple agents can work simultaneously",
      "",
      "### Parallel work",
      "",
